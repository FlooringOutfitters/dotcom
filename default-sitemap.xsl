...
>
	...
	<a href="httpflooringoutfitters.com/"><span>Home</span></a>
	...
	<a href="httpflooringoutfitters.com/"><span>Home</span></a>
			...
			<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
					...
					<a href="httpflooringoutfitters.com/sitemap.xml"><span>Sitemap Index</span></a>
						<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
	...
	<div id="content-head">
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				and was generated on August 10, 2023 at 10:07 pm			</p>
		</xsl:if>
	</div>
</xsl:template>
	...
	<a href="httpflooringoutfitters.com/"><span>Home</span></a>
		...
		<div class="empty-sitemap__buttons">
			<a href="httpflooringoutfitters.com/" class="button">Back to Homepage</a>
					</div>
...
Served from: flooringoutfitters.44.217.172.183.nip.io @ 2023-08-10 22:07:41 by W3 Total Cache
-->